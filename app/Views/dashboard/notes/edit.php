    ...
    <form id="note-form" class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 space-y-6 border border-gray-100"
        ...
        <div class="grid grid-cols-1 gap-4">
          <label class="block">
            ...
            <input type="text" name="title" placeholder="Contoh: Ide proyek baru atau Renungan harian"
                   ...
                   required minlength="1" maxlength="150" value="<?php echo isset($_POST['title']) ? $_POST['title'] : (isset($task['title']) ? $task['title'] : ''); ?>">
          ...
          <label class="block">
            ...
            <textarea 
                ...
                maxlength="10000" 
                rows="5"
            ><?= esc(isset($_POST['content']) ? $_POST['content'] : ($task['content'] ?? '')) ?></textarea>
      ...
      <?php
        ...
        <div 
            x-data="{
            open: false,
            selectedText: '<?= $selectedName ?: 'Pilih aktivitas (opsional)' ?>',

  ...
  <form id="task-form" action="<?= base_url('dashboard/task/store') ?>" method="POST">
    ...
    <div id="paper-container" class="w-full max-w-6xl grid grid-flow-row place-items-center gap-6 transition-all">
      <div class="paper p-6 relative bg-white shadow-lg rounded-2xl transition-all duration-300 transform scale-100">
        ...
        <input type="text" name="titles[]" placeholder="Judul Task" class="w-full text-2xl font-semibold border-none outline-none bg-transparent mb-4 placeholder-gray-400" />

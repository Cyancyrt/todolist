    ...
    <div class="bg-white w-full max-w-sm mx-4 rounded-xl shadow-lg p-6 transform scale-95 transition-transform duration-300" style="max-height: 80vh; overflow-y: auto;">
        ...
        <div class="bg-blue-50 text-gray-800 p-4 rounded-t-xl -m-6 mb-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                <a href="<?= base_url('dashboard/task/edit/' . $task['id']) ?>"
        ...
        <div class="sub-modal-body space-y-3 mt-4">
            ...
            <p class="text-sm text-gray-700"><strong>Deadline:</strong> <span id="subDeadline" class="text-gray-900">-</span></p>
        ...
        <div class="flex flex-col gap-3 mt-6">
            <button id="markCompletedBtn" class="bg-green-600 hover:bg-green-700 text-white text-sm font-medium px-4 py-3 rounded-lg transition-colors duration-200 min-h-[44px]">Mark as Completed</button>
            <button id="markPendingBtn" class="bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium px-4 py-3 rounded-lg transition-colors duration-200 min-h-[44px]">Mark as Pending</button>
        </div>
    </div>
</div>

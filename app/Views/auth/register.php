    ...
    <head>
        ...
        <style>
            ...
            .text-success i { color: #198754; } /* Hijau bootstrap */
            .text-danger i { color: #dc3545; }  /* Merah bootstrap */
            .progress-bar-custom {
            ...
            /* Default: desktop & tablet (tetap typewriter penuh 1 baris) */
            .typewriter {
            ...
            /* Tablet kecil (iPad mini dan sejenisnya) */
            ...
            /* Mobile landscape & bigger phones */
            ...
            /* Mobile small (iPhone SE, Android kecil) */
            @media (max-width: 480px) {
                .typewriter {
                    white-space: normal;          /* <<< BOOL PENTING Supaya teks turun ke baris 2 */
                    border-right: none;           /* Karena multi-line, caret akan jelek */
                    animation: none;              /* Disable typewriter di layar kecil */
                    font-size: 0.9rem;
                    text-align: center;
                }
            }
    ...
    <?php endif; ?>
            ...
            <div class="card register-card p-4" style="max-width: 450px; width: 100%;">
                ...
                <form action="<?= site_url('/register') ?>" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="mt-2 p-2 border rounded bg-light small" id="password-requirements">
                            <p class="mb-1 text-muted fw-bold">Password harus mengandung:</p>
                            <ul class="list-unstyled mb-0 ps-2" style="font-size: 0.85rem;">
                                <li id="req-length" class="text-danger"><i class="fas fa-times me-1"></i> Minimal 8 karakter</li>
                                <li id="req-uppercase" class="text-danger"><i class="fas fa-times me-1"></i> Huruf Besar (A-Z)</li>
                                <li id="req-lowercase" class="text-danger"><i class="fas fa-times me-1"></i> Huruf Kecil (a-z)</li>
                                <li id="req-number" class="text-danger"><i class="fas fa-times me-1"></i> Angka (0-9)</li>
                                <li id="req-symbol" class="text-danger"><i class="fas fa-times me-1"></i> Simbol (!@#$..)</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div id="match-feedback" class="small mt-1 fw-bold text-danger" style="display:none;">
        ...
        <script>
            // --- FITUR BARU: Password Validation Real-time ---
            ...
            const rules = {
                ...
                lowercase: /[a-z]/,
                number: /[0-9]/,
                symbol: /[^A-Za-z0-9]/ // Karakter selain huruf & angka
            };
            ...
            passwordInput.addEventListener('input', function() {
                ...
                // Jika semua valid, update custom validity HTML5 agar form bisa submit
                if (allValid) {
                    passwordInput.setCustomValidity("");
                } else {
                    passwordInput.setCustomValidity("Password belum memenuhi syarat");
                }
            });

            // Cek Konfirmasi Password (Real-time)
            confirmInput.addEventListener('input', function() {
                if (confirmInput.value !== passwordInput.value) {
                    matchFeedback.style.display = 'block';
                    matchFeedback.className = 'small mt-1 fw-bold text-danger';
                    matchFeedback.innerHTML = '<i class="fas fa-times"></i> Password tidak cocok!';
                    confirmInput.setCustomValidity("Password tidak cocok");
                } else {
                    matchFeedback.style.display = 'block';
                    matchFeedback.className = 'small mt-1 fw-bold text-success';
                    matchFeedback.innerHTML = '<i class="fas fa-check"></i> Password cocok!';
                    confirmInput.setCustomValidity("");
                }
                // Sembunyikan jika kosong
                if(confirmInput.value === '') matchFeedback.style.display = 'none';
            });
